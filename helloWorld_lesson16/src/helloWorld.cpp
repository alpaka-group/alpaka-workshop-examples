...
struct HelloWorldKernel {
    ...
    ALPAKA_FN_ACC void operator()(Acc const & acc) const {
        ...
        // Compute threadIdx in another way in lesson 16
        ...
        uint32_t threadIdx = gridBlockIdx * blockThreadExtent + blockThreadIdx;
        // Also print the total number of threads in lesson 16
        printf("Hello, World from alpaka thread %u out of %u!\n", threadIdx, gridThreadExtent);
    }
};
